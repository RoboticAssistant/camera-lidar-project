...
echo_and_run cd "/home/ubuntu/catkin_ws/src/turtlebot_create/create_node"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/ubuntu/catkin_ws/src/turtlebot_create/create_node/setup.py" \
    build --build-base "/home/ubuntu/catkin_ws/build/turtlebot_create/create_node" \
    install \
    $DESTDIR_ARG \
