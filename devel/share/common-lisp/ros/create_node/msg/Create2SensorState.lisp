...
;//! \htmlinclude Create2SensorState.msg.html

(cl:defclass <Create2SensorState> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass Create2SensorState (<Create2SensorState>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <Create2SensorState>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'Create2SensorState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name create_node-msg:<Create2SensorState> is deprecated: use create_node-msg:Create2SensorState instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Create2SensorState>))
...
(cl:defmethod bumps_wheeldrops-val ((m <Create2SensorState>))
...
(cl:defmethod wall-val ((m <Create2SensorState>))
...
(cl:defmethod cliff_left-val ((m <Create2SensorState>))
...
(cl:defmethod cliff_front_left-val ((m <Create2SensorState>))
...
(cl:defmethod cliff_front_right-val ((m <Create2SensorState>))
...
(cl:defmethod cliff_right-val ((m <Create2SensorState>))
...
(cl:defmethod virtual_wall-val ((m <Create2SensorState>))
...
(cl:defmethod motor_overcurrents-val ((m <Create2SensorState>))
...
(cl:defmethod dirt_detector_left-val ((m <Create2SensorState>))
...
(cl:defmethod dirt_detector_right-val ((m <Create2SensorState>))
...
(cl:defmethod remote_opcode-val ((m <Create2SensorState>))
...
(cl:defmethod buttons-val ((m <Create2SensorState>))
...
(cl:defmethod distance-val ((m <Create2SensorState>))
...
(cl:defmethod angle-val ((m <Create2SensorState>))
...
(cl:defmethod charging_state-val ((m <Create2SensorState>))
...
(cl:defmethod voltage-val ((m <Create2SensorState>))
...
(cl:defmethod current-val ((m <Create2SensorState>))
...
(cl:defmethod temperature-val ((m <Create2SensorState>))
...
(cl:defmethod charge-val ((m <Create2SensorState>))
...
(cl:defmethod capacity-val ((m <Create2SensorState>))
...
(cl:defmethod wall_signal-val ((m <Create2SensorState>))
...
(cl:defmethod cliff_left_signal-val ((m <Create2SensorState>))
...
(cl:defmethod cliff_front_left_signal-val ((m <Create2SensorState>))
...
(cl:defmethod cliff_front_right_signal-val ((m <Create2SensorState>))
...
(cl:defmethod cliff_right_signal-val ((m <Create2SensorState>))
...
(cl:defmethod user_digital_inputs-val ((m <Create2SensorState>))
...
(cl:defmethod user_analog_input-val ((m <Create2SensorState>))
...
(cl:defmethod charging_sources_available-val ((m <Create2SensorState>))
...
(cl:defmethod oi_mode-val ((m <Create2SensorState>))
...
(cl:defmethod song_number-val ((m <Create2SensorState>))
...
(cl:defmethod song_playing-val ((m <Create2SensorState>))
...
(cl:defmethod number_of_stream_packets-val ((m <Create2SensorState>))
...
(cl:defmethod requested_velocity-val ((m <Create2SensorState>))
...
(cl:defmethod requested_radius-val ((m <Create2SensorState>))
...
(cl:defmethod requested_right_velocity-val ((m <Create2SensorState>))
...
(cl:defmethod requested_left_velocity-val ((m <Create2SensorState>))
...
(cl:defmethod roslisp-msg-protocol:symbol-codes ((msg-type (cl:eql '<Create2SensorState>)))
    "Constants for message type '<Create2SensorState>"
  '((:OI_MODE_OFF . 0)
    (:OI_MODE_PASSIVE . 1)
    (:OI_MODE_SAFE . 2)
    (:OI_MODE_FULL . 3)
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Create2SensorState>) ostream)
  "Serializes a message object of type '<Create2SensorState>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Create2SensorState>) istream)
  "Deserializes a message object of type '<Create2SensorState>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Create2SensorState>)))
  "Returns string type for a message object of type '<Create2SensorState>"
  "create_node/Create2SensorState")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Create2SensorState)))
  "Returns string type for a message object of type 'Create2SensorState"
  "create_node/Create2SensorState")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Create2SensorState>)))
  "Returns md5sum for a message object of type '<Create2SensorState>"
  "103d192c45e953c8bb1c3c046e89e2ff")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Create2SensorState)))
  "Returns md5sum for a message object of type 'Create2SensorState"
  "103d192c45e953c8bb1c3c046e89e2ff")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Create2SensorState>)))
  "Returns full string definition for message of type '<Create2SensorState>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Create2SensorState)))
  "Returns full string definition for message of type 'Create2SensorState"
  (cl:format cl:nil "uint8 OI_MODE_OFF = 0~%uint8 OI_MODE_PASSIVE = 1~%uint8 OI_MODE_SAFE = 2~%uint8 OI_MODE_FULL = 3~%~%uint8 REMOTE_LEFT = 129~%uint8 REMOTE_FORWARD = 130 ~%uint8 REMOTE_RIGHT = 131 ~%uint8 REMOTE_SPOT = 132 ~%uint8 REMOTE_MAX = 133 ~%uint8 REMOTE_SMALL = 134 ~%uint8 REMOTE_MEDIUM = 135 ~%uint8 REMOTE_LARGE = 136 ~%uint8 REMOTE_CLEAN = 136 ~%uint8 REMOTE_PAUSE = 137 ~%uint8 REMOTE_POWER = 138 ~%uint8 REMOTE_ARC_LEFT = 139 ~%uint8 REMOTE_ARC_RIGHT = 140 ~%uint8 REMOTE_DRIVE_STOP = 141 ~%# Scheduling remote~%uint8 REMOTE_SEND_ALL = 142 ~%uint8 REMOTE_SEEK_DOCK = 143 ~%# Home base~%uint8 REMOTE_RESERVED = 240 ~%uint8 REMOTE_FORCE_FIELD = 242 ~%uint8 REMOTE_GREEN_BUOY = 244 ~%uint8 REMOTE_GREEN_BUOY_AND_FORCE_FIELD = 246 ~%uint8 REMOTE_RED_BUOY = 248 ~%uint8 REMOTE_RED_BUOY_AND_FORCE_FIELD = 250 ~%uint8 REMOTE_RED_BUOY_AND_GREEN_BUOY = 252 ~%uint8 REMOTE_RED_BUOY_AND_GREEN_BUOY_AND_FORCE_FIELD = 254 ~%uint8 REMOTE_NONE = 255~%~%uint8 CHARGING_NOT_CHARGING = 0~%uint8 CHARGING_CHARGING_RECOVERY = 1~%uint8 CHARGING_CHARGING = 2~%uint8 CHARGING_TRICKLE_CHARGING = 3~%uint8 CHARGING_WAITING = 4 ~%uint8 CHARGING_CHARGING_ERROR = 5~%~%Header header~%~%uint8 bumps_wheeldrops~%bool wall~%bool cliff_left~%bool cliff_front_left~%bool cliff_front_right~%bool cliff_right~%bool virtual_wall~%uint8 motor_overcurrents~%uint8 dirt_detector_left  #roomba_only~%uint8 dirt_detector_right #roomba_only~%uint8 remote_opcode~%uint8 buttons~%int16 distance  # mm~%int16 angle # degrees~%uint8 charging_state~%uint16 voltage  # mV~%int16 current  # mA~%int8 temperature  # C~%uint16 charge  # mAh~%uint16 capacity  # mAh~%~%uint16 wall_signal~%uint16 cliff_left_signal~%uint16 cliff_front_left_signal~%uint16 cliff_front_right_signal~%uint16 cliff_right_signal~%uint8 user_digital_inputs~%uint16 user_analog_input~%uint8 charging_sources_available~%uint8 oi_mode~%uint8 song_number~%bool song_playing~%~%uint8 number_of_stream_packets~%int16 requested_velocity  # mm/s~%int16 requested_radius  # mm~%int16 requested_right_velocity  # mm/s~%int16 requested_left_velocity  # mm/s~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <Create2SensorState>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Create2SensorState>))
  "Converts a ROS message object to a list"
  (cl:list 'Create2SensorState
