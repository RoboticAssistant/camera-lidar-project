...
class Create2SensorState {
  ...
  static deserialize(buffer) {
    ...
    let tmp;
    let len;
    let data = new Create2SensorState();
  ...
  static datatype() {
    ...
    return 'create_node/Create2SensorState';
  }
...
module.exports = Create2SensorState;
