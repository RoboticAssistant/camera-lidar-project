...
if("TRUE" STREQUAL "TRUE")
  set(video_analytics_SOURCE_PREFIX /home/ubuntu/catkin_ws/src/video_analytics)
  set(video_analytics_DEVEL_PREFIX /home/ubuntu/catkin_ws/devel)
  ...
  set(video_analytics_INSTALL_PREFIX /home/ubuntu/catkin_ws/install)
...
if(NOT "/home/ubuntu/catkin_ws/src/video_analytics/include " STREQUAL " ")
  set(video_analytics_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/catkin_ws/src/video_analytics/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'video_analytics' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/catkin_ws/src/video_analytics/${idir}'.  Ask the maintainer 'ubuntu <ubuntu@todo.todo>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${video_analytics_dep}_FOUND)
      find_package(${video_analytics_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${video_analytics_dep} REQUIRED ${depend_list})
  endif()
