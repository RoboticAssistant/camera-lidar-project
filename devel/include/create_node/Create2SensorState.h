// Generated by gencpp from file create_node/Create2SensorState.msg
// DO NOT EDIT!


#ifndef CREATE_NODE_MESSAGE_CREATE2SENSORSTATE_H
#define CREATE_NODE_MESSAGE_CREATE2SENSORSTATE_H
...
struct Create2SensorState_
{
  typedef Create2SensorState_<ContainerAllocator> Type;
  ...
  Create2SensorState_(const ContainerAllocator& _alloc)
    : header(_alloc)
    , bumps_wheeldrops(0)
    , wall(false)
    , cliff_left(false)
  ...
  typedef boost::shared_ptr< ::create_node::Create2SensorState_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::create_node::Create2SensorState_<ContainerAllocator> const> ConstPtr;

}; // struct Create2SensorState_

typedef ::create_node::Create2SensorState_<std::allocator<void> > Create2SensorState;

typedef boost::shared_ptr< ::create_node::Create2SensorState > Create2SensorStatePtr;
typedef boost::shared_ptr< ::create_node::Create2SensorState const> Create2SensorStateConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::create_node::Create2SensorState_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::create_node::Create2SensorState_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
// {'nav_msgs': ['/opt/ros/kinetic/share/nav_msgs/cmake/../msg'], 'actionlib_msgs': ['/opt/ros/kinetic/share/actionlib_msgs/cmake/../msg'], 'std_msgs': ['/opt/ros/kinetic/share/std_msgs/cmake/../msg'], 'geometry_msgs': ['/opt/ros/kinetic/share/geometry_msgs/cmake/../msg'], 'create_node': ['/home/ubuntu/catkin_ws/src/turtlebot_create/create_node/msg'], 'diagnostic_msgs': ['/opt/ros/kinetic/share/diagnostic_msgs/cmake/../msg']}
...
template <class ContainerAllocator>
struct IsFixedSize< ::create_node::Create2SensorState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::create_node::Create2SensorState_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::create_node::Create2SensorState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::create_node::Create2SensorState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::create_node::Create2SensorState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::create_node::Create2SensorState_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::create_node::Create2SensorState_<ContainerAllocator> >
{
  ...
  static const char* value(const ::create_node::Create2SensorState_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x103d192c45e953c8ULL;
  static const uint64_t static_value2 = 0xbb1c3c046e89e2ffULL;
};

template<class ContainerAllocator>
struct DataType< ::create_node::Create2SensorState_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::create_node::Create2SensorState_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::create_node::Create2SensorState_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::create_node::Create2SensorState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::create_node::Create2SensorState_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // CREATE_NODE_MESSAGE_CREATE2SENSORSTATE_H
