#ifndef DECONVOLUTIONAL_LAYER_HPP
#define DECONVOLUTIONAL_LAYER_HPP
...
void update_deconvolutional_layer(deconvolutional_layer layer, int temp, float learning_rate, float momentum, float decay);
